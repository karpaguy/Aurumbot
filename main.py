...
while cxy == False:
    if pyautogui.locateOnScreen('Images-PTBR\\SinoBorder.png', confidence=0.90) != None:
        print('Achei')
        blx, bly = pyautogui.locateCenterOnScreen('Images-PTBR\\SinoBorder.png', confidence=0.85)
        cxy = True
    else:
...
while keyboard.is_pressed("q") == False:
    while Combate == False:
        ...
        while time.time() - start < 2:
            if pyautogui.locateOnScreen('Images-PTBR\\Mantis_Body.png' or 'Images-PTBR\\Mantis_Body_Alt.png' , confidence=0.7) != None:
                Mantis = True
                if Mantis == True:
                    start = 2
            else:
    ...
    while Barragem == True:
        if pyautogui.locateOnScreen('Images-PTBR\\Barragem_de_Gemas.png', confidence=0.95) != None:
                    btnx, btny = pyautogui.locateCenterOnScreen('Images-PTBR\\Barragem_de_Gemas.png', confidence=0.95)
                    time.sleep(0.3)
